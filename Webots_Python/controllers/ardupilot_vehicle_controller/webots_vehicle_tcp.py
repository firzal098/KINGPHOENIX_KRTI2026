...
class WebotsArduVehicle():
    ...
    def __init__(self,
        ...
        #     self.camera2.enable(1000 // camera2_fps) # Shared framerate with camera 1

        #     # start camera 2 streaming thread if requested
