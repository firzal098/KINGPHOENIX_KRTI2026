...
def get_args():
    ...
    parser.add_argument("--camera2",
                        type=str,
                        default=None,
                        help="Webots second Camera name (optional)")
    parser.add_argument("--camera2-fps",
                        type=int,
                        default=10,
                        help="Second camera FPS. Note lower FPS is faster")
    parser.add_argument("--camera2-port",
                        type=int,
                        default=None,
                        help="Port to stream grayscale second camera images to. "
                             "If no port is supplied the second camera will not be streamed.")
...
if __name__ == "__main__":
    ...
    vehicle = WebotsArduVehicle(motor_names=motors,
                                ...
                                camera2_name=args.camera2,                 # ADD THIS LINE
                                camera2_fps=args.camera2_fps,              # ADD THIS LINE
                                camera2_stream_port=args.camera2_port,     # ADD THIS LINE
